...
const buttonVariants = cva(
  // No `outline-none` and no translucent focus ring (shadcn defaults): focus
  // comes from the global `:focus-visible` 2px solid --ring treatment, which
  // is the NFR-2 baseline (a 50%-opacity ring risks failing 3:1 non-text
  // contrast).
